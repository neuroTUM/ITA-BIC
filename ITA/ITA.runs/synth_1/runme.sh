...
HD_PWD='/tmp/mnt_ryloth_ipek/vivado_projects/ITA_Project/ITA/ITA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ita_hwpe_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ita_hwpe_top.tcl
